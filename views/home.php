...
<body>
                            ...
                            <div class="s003">
                                <form>
                                    ...
                                    <div class="input-field second-wrap">
                                        <input id="search" oninput="getdata(event)" type="text" placeholder="Enter Keywords?" />
                                    </div>
                                    <div class="input-field third-wrap">
                                        <button class="btn-search" onclick="getdata(event)" id="search-btn" type="button">
    ...
    getdata({
        currentTarget: document.getElementById('search')
    });
